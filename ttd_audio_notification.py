...
# Changelog:
# - v1.1.0: Moved credentials from a separate confidential.ini to config.ini.
#           Enhanced logging, added log rotation and archiving.
#           Added modular functions for better code readability and maintenance.
...
# Define path to the config.ini file
...
ftp_server = config['ttd_audio_notification_ftp']['ftp_server']
ftp_port = int(config['ttd_audio_notification_ftp']['ftp_port'])
ftp_user = config['ttd_audio_notification_ftp']['ftp_user']
ftp_pass = config['ttd_audio_notification_ftp']['ftp_pass']
...
pushover_token = config['ttd_audio_notification_Pushover']['pushover_token']
pushover_user_key = config['ttd_audio_notification_Pushover']['pushover_user']
